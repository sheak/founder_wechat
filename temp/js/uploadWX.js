...
wx.ready(function () {
  ...
  //   images.serverId = [];
  //   $("#upImg").append('<input id="serverId" type="text" value="" name="serverId">');
  //   function upload() {
  //     wx.uploadImage({
  ...
  //       // 本地预览
  //       $("#chooseImage").append('<img id="uploadPreview" src="'+images.localId[0]+'"><span class="reUpload">重新上传</span>');
  ...
  //   }
  //   upload();
  //   $("#upImg").append('<input type="hidden" value="'+images.serverId.join(",")+'" name="serverId">');
  // };
